    ...
    >
      ...
      <div ref={ref} className="relative   mx-auto ">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pt-40 md:gap-10 md:pb-10"
          >
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-0.5 bg-linear-to-t from-blue-400 via-blue-600 to-transparent from-0% via-10% rounded-full"
          />
        </div>
      </div>
    </div>
